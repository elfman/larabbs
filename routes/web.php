...
Route::get('password/update', 'Auth\ModifyPasswordController@updatePassword')->name('users.updatePassword');
Route::post('password/modify', 'Auth\ModifyPasswordController@modifyPassword')->name('users.modifyPassword');
